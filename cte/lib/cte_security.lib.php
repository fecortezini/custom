<?php
/* Copyright (C) 2024-2026 CT-e Module
 *
...
/**
 * \file    custom/cte/lib/cte_security.lib.php
 * \ingroup cte
 ...
 */
function getCteCertPasswordKey($db)
{
 ...
 */
function cteEncryptPassword($password, $db)
{
    if ($password === '') {
        return '';
    }
    
    $key = getCteCertPasswordKey($db);
 ...
 */
function cteDecryptPassword($encryptedPassword, $db)
{
