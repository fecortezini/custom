...
if (isset($this->std->infdps->serv->obra)) {
    ...
    // Campo: cObra (obrigatório se obra existir)
...
// Grupo atvEvento - DEVE vir DEPOIS de obra no schema XML
