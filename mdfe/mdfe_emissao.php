...
try {
    // Certificado carregado via carregarCertificadoA1Nacional() — não usar senhas hardcoded
    throw new Exception('Este arquivo é legado. Use mdfe_processar.php para emissão de MDF-e.');
