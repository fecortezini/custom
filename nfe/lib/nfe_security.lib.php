<?php
/* Copyright (C) 2024-2026 NFe Module
 *
...
/**
 * \file    custom/nfe/lib/nfe_security.lib.php
 * \ingroup nfe
 ...
 */
function getNfeCertPasswordKey($db)
{
 ...
 */
function nfeEncryptPassword($password, $db)
{
    if ($password === '') {
        return '';
    }
    
    $key = getNfeCertPasswordKey($db);
 ...
 */
function nfeDecryptPassword($encryptedPassword, $db)
{
