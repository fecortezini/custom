 ...
 */
function getCsosn($mysoc, $dest, $prdRegimeIcms, $isencaoICMS)
{   
    $indIEDest = $dest['extrafields']['indiedest'];
    $regime_tributario = $dest['extrafields']['regime_tributario'];
    $crt = $mysoc['crt'];
